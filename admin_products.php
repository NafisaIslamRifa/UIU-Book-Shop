...
if(isset($_POST['add_product'])){
   ...
   if(mysqli_num_rows($select_product_name) > 0){
      ...
      $add_product_query = mysqli_query($conn, "INSERT INTO `book`(Book_Id, Book_Title,Publication_Year,Book_Price,Author_Id,Book_Image) VALUES('$book_id', '$name', '$book_date',' $price','$author_id','$image')");
